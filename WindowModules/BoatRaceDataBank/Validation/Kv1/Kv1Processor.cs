...
namespace ApplicationSuite.WindowModules.BoatRaceDataBank.Validation.Kv1
{
    ...
    {
        public async Task<IReadOnlyList<ValidateResult>> RunCheckBatchAsync(
                ...
                CancellationToken ct = default)
        {
            ...
            return await Task.Run(() =>
            {
                ...
                var bag = new ConcurrentBag<(int Index, ValidateResult Result)>();
                ...
                Parallel.ForEach<IndexedPath, Kv1Session>(
                    ...
                    body: (item, loopState, session) =>
                    {
                        ...
                        finally
                        {
                            ...
                            // ValidateResult は UI でそのまま整形・表示できる共通モデル
                ...
                return (IReadOnlyList<ValidateResult>)ordered;
